...
<head>
    ...
    <title>Categories Display</title>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-xs-6">
                            <h2>Display <b>Categories</b></h2>
                        </div>
                        <div class="col-xs-6">
                            <a href="frmAddCategory.php" class="btn btn-success"><i class="material-icons">&#xE147;</i>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success"><a
                                            href='frmUpdateCategory.php?id=<?php echo $row['catId']; ?>'
                                            style="color: white; text-decoration: none;">Edit</a></button>
                                    <button type="button" class="btn btn-danger"><a
                                            href='deleteCategory.php?id=<?php echo $row['catId']; ?>'
